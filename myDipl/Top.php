...
$query = "SELECT * FROM `product` where id_prod = 13 and kat='Top'";
$query1 = "SELECT * FROM `product` where id_prod = 14 and kat='Top'";
$query2 = "SELECT * FROM `product` where id_prod = 15 and kat='Top'";
$query3 = "SELECT * FROM `product` where id_prod = 16 and kat='Top'";
$query4 = "SELECT * FROM `product` where id_prod = 17 and kat='Top'";
$query5 = "SELECT * FROM `product` where id_prod = 18 and kat='Top'";
$query6 = "SELECT * FROM `product` where id_prod = 19 and kat='Top'";
$query7 = "SELECT * FROM `product` where id_prod = 20 and kat='Top'";
$query8 = "SELECT * FROM `product` where id_prod = 21 and kat='Top'";
$query9 = "SELECT count(*) FROM `shopcart`";
...
$result8 = mysqli_query($connect, $query7);
$result9 = mysqli_query($connect, $query8);
$result_cart = mysqli_query($connect, $query9);
...
<head>
  ...
  <title>Cветодиодные фигуры</title>
</head>
<style>
  html {
    ...
    <section class="py-5 text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          <h1 class="font-weight-light">Топиарные и светодиодные фигуры</h1>
          <p class="lead text-muted"> Топиарная фигура – это скульптура из декоративного растительного материала.
            Топиари - это настоящее прикладное искусство в ландшафтном дизайне.светодиодные украшения.<br>
            Светодиодные фигуры - это фигуры из пластика, акрила, оргстекла или другого материала. Некоторые крупные виды таких украшений оснащены металлическим каркасом, чтобы конструкция была твёрдой.
            У одних изделий светодиоды находятся внутри, другие оборудованы лампочками снаружи.</p>
