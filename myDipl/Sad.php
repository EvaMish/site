...
$query = "SELECT * FROM `product` where id_prod = 7 and kat='Sad'";
$query1 = "SELECT * FROM `product` where id_prod = 8 and kat='Sad'";
$query2 = "SELECT * FROM `product` where id_prod = 9 and kat='Sad'";
$query3 = "SELECT * FROM `product` where id_prod = 10 and kat='Sad'";
$query4 = "SELECT * FROM `product` where id_prod = 11 and kat='Sad'";
$query5 = "SELECT * FROM `product` where id_prod = 12 and kat='Sad'";
...
<head>
  ...
  <title>Садово-парковая мебель</title>
</head>
<style>
  html {
    ...
    <section class="py-5 text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          <h1 class="font-weight-light">Садово-парковая мебель</h1>
          <p class="lead text-muted"> Это комплекс решений, с помощью которых обеспечивается комфортные условия пребывания на территории сада, парка,
            частных владений, лесопарковых зон.</p>
